...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'user.hackerrank'
        db.add_column(u'caped_crusader_user', 'hackerrank',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'user.hackerrank'
        db.delete_column(u'caped_crusader_user', 'hackerrank')
    ...
    models = {
        ...
        u'caped_crusader.user': {
            ...
            'hackerrank': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
