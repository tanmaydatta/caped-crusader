...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Codeforces.name'
        db.add_column(u'caped_crusader_codeforces', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Codeforces.name'
        db.delete_column(u'caped_crusader_codeforces', 'name')
