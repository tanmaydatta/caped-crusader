...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Codeforces'
        db.create_table(u'caped_crusader_codeforces', (
        ...
        db.send_create_signal(u'caped_crusader', ['Codeforces'])


    def backwards(self, orm):
        # Deleting model 'Codeforces'
        db.delete_table(u'caped_crusader_codeforces')
