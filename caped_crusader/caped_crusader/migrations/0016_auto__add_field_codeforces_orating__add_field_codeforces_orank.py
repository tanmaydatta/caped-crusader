...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Codeforces.orating'
        db.add_column(u'caped_crusader_codeforces', 'orating',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Codeforces.orank'
        db.add_column(u'caped_crusader_codeforces', 'orank',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Codeforces.orating'
        db.delete_column(u'caped_crusader_codeforces', 'orating')

        # Deleting field 'Codeforces.orank'
        db.delete_column(u'caped_crusader_codeforces', 'orank')
