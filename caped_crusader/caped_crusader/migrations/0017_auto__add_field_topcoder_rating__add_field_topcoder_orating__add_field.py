...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topcoder.rating'
        db.add_column(u'caped_crusader_topcoder', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Topcoder.orating'
        db.add_column(u'caped_crusader_topcoder', 'orating',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Topcoder.rank'
        db.add_column(u'caped_crusader_topcoder', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Topcoder.orank'
        db.add_column(u'caped_crusader_topcoder', 'orank',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topcoder.rating'
        db.delete_column(u'caped_crusader_topcoder', 'rating')

        # Deleting field 'Topcoder.orating'
        db.delete_column(u'caped_crusader_topcoder', 'orating')

        # Deleting field 'Topcoder.rank'
        db.delete_column(u'caped_crusader_topcoder', 'rank')

        # Deleting field 'Topcoder.orank'
        db.delete_column(u'caped_crusader_topcoder', 'orank')
    ...
    models = {
        ...
        u'caped_crusader.topcoder': {
            ...
            'handle': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orank': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'orating': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
