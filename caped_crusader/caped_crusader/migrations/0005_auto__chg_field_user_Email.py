...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'caped_crusader_user', 'Email', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'caped_crusader.user': {
            'Email': ('django.db.models.fields.CharField', [], {'default': "'test@test.com'", 'max_length': '100'}),
